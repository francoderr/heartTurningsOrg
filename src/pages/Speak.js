...
import SpeakBackdrop from "../assets/SpeakBackdrop.svg";
import SpeakBackdrop2 from "../assets/SpeakBackdrop2.svg";
  ...
  return (
    <Stack>
      <Stack
        ...
        width={"100%"}
        sx={{
          backgroundImage: `url(${SpeakBackdrop})`,
      ...
      >
        <Stack
          ...
          width={"90%"}
          sx={{
            backgroundImage: `url(${SpeakBackdrop2})`,
            backgroundSize: "cover",
            backgroundRepeat: "no-repeat",
            backgroundPosition: "center",
          }}
